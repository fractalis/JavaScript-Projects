...
const Calculator = {
    ...
    Display_Value: '0',
    // This will hold the first operand for anyt expressions, we sit it to null for now
    First_Operand: null,
...
function Input_Digit(digit) {
    ...
    if (Wait_Second_Operand === true) {
        ...
        // others it adds onto it
        Calculator.Display_Value = Display_Value === '0' ? digit : Display_Value + digit;
    }
}

// This second handles decimal points
