// This keeps track of our scores
let scores = {
    playerScore: 0,
    computerScore: 0
}
...
function updateScoreboard() {
    document.getElementById('player-score').innerHTML = 'Player Score: ' + scores.playerScore;
    document.getElementById('computer-score').innerHTML = 'Computer Score: ' + scores.computerScore;
}
...
function placeXOrO(squareNumber) {
    ...
    function computersTurn() {
        ...
        while(!success) {
            ...
            // If the random number evaluate returns true, the square hasn't been selected yet.
...
function checkWinConditions() {
    ...
    // O 0, 1, 2 condition.
        ...
        // Computer Scored, so increment it
    ...
    // and 9 squares are selected, the code executes.
        ...
        audio('./media/tie.wav');
        // This fucntion sets a .3 second timer before the resetGame is called.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    setTimeout(function () { clear(); updateScoreboard(); resetGame(); }, 1000);
}
